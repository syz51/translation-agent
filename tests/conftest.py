...
def isolated_repo_env_file(monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:
    monkeypatch.setattr("translation_agent.config.DEFAULT_ENV_FILE", tmp_path / ".env")
